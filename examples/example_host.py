...
sequence = Scene_sequence([
    ...
    Overlay(LinearTransition(Image("images/stroj_schody.png"), Tweet("https://twitter.com/jiri_skorpik/status/1896819822132109509", duration=10), transition_time=1), "overlays/oei.png"),
    Tweet("https://twitter.com/jiri_skorpik/status/1593271304773304323", duration=10),
])

#remove cache

clear_cache(period=60)
complex_sequence = Scene_sequence([sequence, sequence])
complex_sequence.render_flattened(threads=4)
